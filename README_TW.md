...
<p>這是由作者zakoxun（前skymc）自己開發的第三方主題，不是官方主題</p>
<p>你可以拿去二創，但不要拿來對接我的專案</p>
<br>
<h1>更新日誌</h1>
<br>

·支援mcsm9/10版本，mcsm以下版本（v9.9.0）請直接提取&下載（點擊可直接下載）oldversions資料夾裡面的 [MCSM9舊版](oldversions/onimai-mcsm9-oldbuild-oldversion.zip) 即可
